...
void main() {
  test('Cannot land on a blockade', () {
    ...
    final red = [
      ...
      for (int i = 2; i < 4; i++) Piece(PlayerColor.red, i, const PiecePosition(-1))
    ];

    // Green tries to move onto index 5 from index 3 with die=2
    final greenPiece = Piece(PlayerColor.green, 0, const PiecePosition(3, isHome: false));
    final green = [greenPiece, for (int i = 1; i < 4; i++) Piece(PlayerColor.green, i, const PiecePosition(-1))];
